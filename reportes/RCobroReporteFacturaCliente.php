...
class RCobroReporteFacturaCliente extends  ReportePDF {
	var $cabecera;
	//var $detalleCbte;
	var $ancho_hoja;
	...
	function Header() {
			    ...
			    ob_start();
				include(dirname(__FILE__).'/../reportes/tpl/refacocli/cabecera.php');
	 ...
	 function generarReporte() {
		...
		*/
		...
		//adiciona glosa
		ob_start();
		include(dirname(__FILE__).'/../reportes/tpl/refacocli/glosa.php');
        $content = ob_get_clean();
		
		ob_start();
		include(dirname(__FILE__).'/../reportes/tpl/refacocli/cuerpo2.php');
