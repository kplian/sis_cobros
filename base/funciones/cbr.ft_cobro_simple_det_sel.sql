CREATE OR REPLACE FUNCTION cbr.ft_cobro_simple_det_sel (
...
/**************************************************************************
 ...
 FUNCION: 		cbr.ft_cobro_simple_det_sel
 DESCRIPCION:   Funcion que devuelve conjuntos de registros de las consultas relacionadas con la tabla 'cbr.tcobro_simple_det'
 AUTOR: 		 (admin)
...
BEGIN
	...
	v_nombre_funcion = 'cbr.ft_cobro_simple_det_sel';
    v_parametros = pxp.f_get_record(p_tabla);

	/*********************************    
 	#TRANSACCION:  'CBR_PASIDE_SEL'
 	#DESCRIPCION:	Consulta de datos
 	#AUTOR:		admin	
 	#FECHA:		01-01-2018 06:21:25
	***********************************/

	if(p_transaccion='CBR_PASIDE_SEL')then
     				
    	begin
    		--Sentencia de la consulta
			v_consulta:='select
						paside.id_cobro_simple_det,
						paside.estado_reg,
						...
						from cbr.tcobro_simple_det paside
	...
	/*********************************    
 	#TRANSACCION:  'CBR_PASIDE_CONT'
 	#DESCRIPCION:	Conteo de registros
 	#AUTOR:		admin	
 	#FECHA:		01-01-2018 06:21:25
	***********************************/

	elsif(p_transaccion='CBR_PASIDE_CONT')then

		begin
			--Sentencia de la consulta de conteo de registros
			v_consulta:='select count(id_cobro_simple_det),
                        ...
                        COALESCE(sum(paside.importe_mb),0)::numeric  as total_importe_det_mb,
                        COALESCE(sum(paside.importe_mt),0)::numeric  as total_importe_det_mt
