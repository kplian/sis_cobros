CREATE OR REPLACE FUNCTION cbr.f_inserta_cobro (
...
BEGIN
	 ...
	 v_nombre_funcion = 'cbr.f_inserta_cobro';
	...
	For item in (
      ...
      (param.f_get_tipo_cambio(3,cbre.fecha::DATE,'O')):: numeric AS tipo_cambio_ma
       ...
       WHERE
       dcv.nro_documento = cbre.nro_documento and  pla.tipo_plantilla = 'venta' and dcv.importe_doc=cbre.importe_doc and cbre.fecha=dcv.fecha
...
ALTER FUNCTION cbr.f_inserta_cobro (p_administrador integer, p_id_usuario integer, p_tabla varchar)
  OWNER TO postgres;