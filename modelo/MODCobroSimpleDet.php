...
/**
*@package pXP
*@file gen-MODCobroSimpleDet.php
*@author  (admin)
*@date 01-01-2018 06:21:25
*@description Clase que envia los parametros requeridos a la Base de datos para la ejecucion de las funciones, y que recibe la respuesta del resultado de la ejecucion de las mismas
*/

class MODCobroSimpleDet extends MODbase{
	...
	function listarCobroSimpleDet(){
		...
		$this->procedimiento='cbr.ft_cobro_simple_det_sel';
		$this->transaccion='CBR_PASIDE_SEL';
		...
		$this->capturaCount('total_importe_det_mb','numeric');
		$this->capturaCount('total_importe_det_mt','numeric');
				
		//Definicion de la lista del resultado del query
		$this->captura('id_cobro_simple_det','int4');
	...
	function insertarCobroSimpleDet(){
		...
		$this->procedimiento='cbr.ft_cobro_simple_det_ime';
		$this->transaccion='CBR_PASIDE_INS';
	...
	function modificarCobroSimpleDet(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='cbr.ft_cobro_simple_det_ime';
		$this->transaccion='CBR_PASIDE_MOD';
		$this->tipo_procedimiento='IME';
				
		//Define los parametros para la funcion
		$this->setParametro('id_cobro_simple_det','id_cobro_simple_det','int4');
		$this->setParametro('estado_reg','estado_reg','varchar');
		$this->setParametro('id_cobro_simple','id_cobro_simple','int4');
		$this->setParametro('id_doc_compra_venta','id_doc_compra_venta','int4');
	...
	function eliminarCobroSimpleDet(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='cbr.ft_cobro_simple_det_ime';
		$this->transaccion='CBR_PASIDE_ELI';
		$this->tipo_procedimiento='IME';
   ...
   function relacionarFacturaCobro(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='cbr.ft_cobro_simple_det_ime';
		$this->transaccion='CBR_RELFAC_IME';
		$this->tipo_procedimiento='IME';
				
		//Define los parametros para la funcion
		$this->setParametro('id_cobro_simple','id_cobro_simple','int4');
		$this->setParametro('id_doc_compra_venta','id_doc_compra_venta','int4');
		$this->setParametro('monto_prorrateo','monto_prorrateo','numeric');
