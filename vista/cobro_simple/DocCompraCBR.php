...
Phx.vista.DocCompraCBR = {
	...
	constructor: function(config) {
	    ...
	    Phx.vista.DocCompraCBR.superclass.constructor.call(this,config);
    ...
    loadValoresIniciales: function() {
    	Phx.vista.DocCompraCBR.superclass.loadValoresIniciales.call(this);
        //this.Cmp.tipo.setValue(this.tipoDoc); 
        
   },
   capturaFiltros:function(combo, record, index){
        this.store.baseParams.tipo = this.tipoDoc;
        Phx.vista.DocCompraCBR.superclass.capturaFiltros.call(this,combo, record, index);
   },
   ...
   abrirFormulario: function(tipo, record){
   	       var me = this;
   	                ...
   	                me.objSolForm = Phx.CP.loadWindows('../../../sis_cobros/vista/pago_simple/FormRendicionCBR.php',
			                                me.formTitulo,
			                                {
			                                    modal:true,
			                                    width:'90%',
